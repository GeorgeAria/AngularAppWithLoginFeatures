...
namespace SecuringAngularApps.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // This method requires users to submit an access token and fulfill some requirements to use this API.
            ...
            // This method requires any calls to this API to be done only by authenticated users.
